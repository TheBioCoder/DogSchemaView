...
for x in range(38):
    ...
    corMap, labelNames, labelColors = formatData.mainCorrelationMap(geneList, slices, location)
    displayGraphics.buildConnectivityMap(slices, length, geneList, corMap, labelNames, labelColors)    
