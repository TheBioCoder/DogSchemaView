...
def showLayout():
    ...
    layout = [[sg.Text('Please click a button', auto_size_text=True)],
              [sg.Button('1', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='1'), sg.Button('2', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='2'), sg.Button('3', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='3'), sg.Button('4', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='4'), sg.Button('5', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='5'), sg.Button('6', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='6'), sg.Button('7', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='7'), sg.Button('8', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='8'), sg.Button('9', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='9'), sg.Button('10', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='10'), sg.Button('11', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='11')], [sg.Button('12', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='12'), sg.Button('13', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='13'), sg.Button('14', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='14'), sg.Button('15', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='15'), sg.Button('16', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='16'), sg.Button('17', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='17'), sg.Button('18', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='18'), sg.Button('19', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='19'), sg.Button('20', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='20'), sg.Button('21', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='21'), sg.Button('22', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='22')], [sg.Button('23', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='23'), sg.Button('24', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='24'), sg.Button('25', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='25'), sg.Button('26', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='26'), sg.Button('27', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='27'), sg.Button('28', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='28'), sg.Button('29', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='29'), sg.Button('30', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='30'), sg.Button('31', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='31'), sg.Button('32', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='32'), sg.Button('33', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='33')], [sg.Button('34', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='34'), sg.Button('35', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='35'), sg.Button('36', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='36'), sg.Button('37', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='37'), sg.Button('38', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='38'), sg.Button('39', image_data=chromosome,
              button_color=('black',sg.theme_background_color()),
              border_width=0, key='39')]]
    return layout
...
def viewLoop(window, dogName):
    ...
    while True:
        ...
        if event in dispatch_dictionary:
            ...
            corMap, labelNames, labelColors = formatData.mainCorrelationMap(get(file + 'geneList'), get(file + 'alignedSlices'), get(file + 'location'))
            print(len(labelNames), len(corMap))
            return displayGraphics.buildConnectivityMap(get(file + 'alignedSlices'), get(file + 'length'), get(file + 'geneList'), corMap, labelNames, labelColors)
        else:
            print('Event {} not in dispatch dictionary'.format(event))

#dogName = 'Masha'
#chromosomeNumber = 1
#file = '%s/%d/' % (dogName, chromosomeNumber)
#print(file)
#corMap, labelNames, labelColors = formatData.mainCorrelationMap(get(file + 'geneList'), get(file + 'alignedSlices'), get(file + 'location'))

#displayGraphics.buildConnectivityMap(get(file + 'alignedSlices'), get(file + 'length'), get(file + 'geneList'), corMap, labelNames, labelColors)    
